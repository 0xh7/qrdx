...
export const metadata: Metadata = {
  title: "Pricing — QRDX",
  description: "Choose the perfect plan for your QR code needs. Start free, upgrade when ready.",
  robots: "index, follow",
};
      ...
      <div className="relative container mx-auto space-y-28 px-4 py-20 md:px-6">
        ...
        <section className="space-y-2 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-3xl text-base text-balance md:text-lg">
            Start creating beautiful QR codes for free. Upgrade to Pro when you&apos;re ready.
          </p>
        </section>
...
const PRICING_FAQS = [
  {
    ...
    answer: `You get unlimited saved QR themes, priority support, early access to new features, and more coming soon. We're constantly developing new features for Pro users!`,
  },
  {
    question: "Can I still use QRDX for free?",
    answer: `Yes! QRDX provides a comprehensive free tier that includes full QR code customization, access to all preset styles, and up to 3 saved themes. You can create and download QR codes without any payment required.`,
  },
  {
    question: "Does QRDX offer a free trial for the Pro plan?",
    answer: `No, there are no free trials. However, you get full access to create unlimited QR codes with the free tier, plus you can save up to 3 themes without any payment.`,
  },
  {
